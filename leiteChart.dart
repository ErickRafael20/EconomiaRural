...
class LeiteChart extends StatefulWidget {
  @override
  _LeiteChartState createState() => _LeiteChartState();
}

class _LeiteChartState extends State<LeiteChart> {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if (lengthList != index || index == 0){
      leite = "Leite: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      leite = "Leite: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qnt = "Litros: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qnt = "Litros: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Qnt"]}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(leite,qnt,result)
            )else(
                tabelaResult(leite, qnt, result)
            )
          ],
        ),
      ),
