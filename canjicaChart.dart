...
class CanjicaChart extends StatefulWidget {
  @override
  _CanjicaChartState createState() => _CanjicaChartState();
}

class _CanjicaChartState extends State<CanjicaChart> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            fileLength = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["LengthIncrement"];
          ...
          Expanded(
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  int indexOrder = 0;
                  indexOrder = index + 1;
                  return _canjicaChartList(context, index, indexOrder.toString());
                }),
          )
        ],
      ),
  ...
  Future loadJson() async {
    final jsonFile = await JsonPath().localGAnimaisFileJson;
  ...
  Widget _canjicaChartList(BuildContext context, int index, String nameOrder) {
    String datasTxt;
    String data;
    String canjica;
    String qntSacos;
    ...
    if(lengthList != index || index == 0) {
      datasTxt =
      fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]
          .keys.toList()[4 + index];

      valor1Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][0];
      resultCheck = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][2];
    }

    valor2Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Valor"];
    result2Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Result"];
    ...
    if(lengthList != index || index == 0){
      data = "Data: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Data"]}";
    }else {
      data = "Total Gasto";
    }

    if (lengthList != index || index == 0){
      canjica = "Canjica: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      canjica = "Canjica: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qntSacos = "Qnt de Sacos: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qntSacos = "Qnt de Sacos: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Qnt"]}";
    }

    if(lengthList != index || index == 0){
      result = "Total: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][2].toStringAsPrecision(strPrc[2])} ";
    }else {
      result = "Total: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["Result"].toStringAsPrecision(strPrc[3])}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(canjica,qntSacos,result)
            )else(
                tabelaResult(canjica, qntSacos, result)
            )
          ],
        ),
      ),
  ...
  Widget tabelaGastos(String canjica,qntSacos,result){
    return Container(
  ...
  Widget tabelaResult(String canjica,qntSacos,result){
    return  Container(
      padding: EdgeInsets.only(top: 1.5 * SizeConfig.blockSizeVertical),
      height: 12 * SizeConfig.blockSizeVertical,
      width: 50 * SizeConfig.blockSizeHorizontal,
  ...
  Future deleteButton(int indexCard, ) async {
    ...
    datasTxt = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName].keys.toList()[4+indexCard];
    final jsonFile = await JsonPath().localGAnimaisFileJson;

    for (int i = 0; i <= 2; i++){
      fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][listNameJson[i]] =
          fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][listNameJson[i]] -
              fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][i];
    }

    fileContent[jsonStart][indexYearDropDown][jsonName]["Result"] = fileContent[jsonStart][indexYearDropDown][jsonName]["Result"] -
        fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName][datasTxt]["Valores"][2];

    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName].removeWhere((key, value) => key == datasTxt);
    ...
    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1][jsonName]["LengthIncrement"] = fileLength;
