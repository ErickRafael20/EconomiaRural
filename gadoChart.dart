...
class GadoChart extends StatefulWidget {
  @override
  _GadoChartState createState() => _GadoChartState();
}

class _GadoChartState extends State<GadoChart> {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if (lengthList != index || index == 0){
      gado = "Gado: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      gado = "Gado: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qnt = "Quantidades: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qnt = "Quantidades: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Qnt"]}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(gado,qnt,result)
            )else(
                tabelaResult(gado, qnt, result)
            )
          ],
        ),
      ),
