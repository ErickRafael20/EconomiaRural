...
class OutrasVendas1Chart extends StatefulWidget {
  @override
  _OutrasVendas1ChartState createState() => _OutrasVendas1ChartState();
}

class _OutrasVendas1ChartState extends State<OutrasVendas1Chart> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            print(indexDropDown);
                            fileLength = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["LengthIncrement"];
                            print("$fileLength file length before");
                            length = fileLength + 1;
                            if(length == 1){
                              length = 0;
                            }
