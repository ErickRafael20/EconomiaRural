...
class QueijoChart extends StatefulWidget {
  @override
  _QueijoChartState createState() => _QueijoChartState();
}

class _QueijoChartState extends State<QueijoChart> {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if (lengthList != index || index == 0){
      queijo = "Queijo: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      queijo = "Queijo: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qnt = "Quantidades: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qnt = "Quantidades: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2][jsonName]["Qnt"]}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(queijo,qnt,result)
            )else(
                tabelaResult(queijo, qnt, result)
            )
          ],
        ),
      ),
