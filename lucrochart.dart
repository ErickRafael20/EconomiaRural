...
class OvoChart extends StatefulWidget {
  @override
  _OvoChartState createState() => _OvoChartState();
}

class _OvoChartState extends State<OvoChart> {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if (lengthList != index || index == 0){
      ovo = "Ovo: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      ovo = "Ovo: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qnt = "Dúzias: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qnt = "Dúzias: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Qnt"]}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(ovo,qnt,result)
            )else(
                tabelaResult(ovo, qnt, result)
            )
          ],
        ),
      ),
