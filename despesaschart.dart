...
class MilhoChart extends StatefulWidget {
  @override
  _MilhoChartState createState() => _MilhoChartState();
}

class _MilhoChartState extends State<MilhoChart> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            fileLength = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["LengthIncrement"];
                            length = fileLength + 1;
                            if(length == 1){
                              length = 0;
                            }
  ...
  void loadDropDownYear(){
    int x = 0;
    print(fileContent[jsonStart][indexYearDropDown][chooseYear][11][chooseMonth][0][jsonName]);
    setState(() {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if(lengthList != index || index == 0) {
      datasTxt =
      fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]
          .keys.toList()[4 + index];

      valor1Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][0];
      resultCheck = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][2];
    }

    valor2Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Valor"];
    result2Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Result"];
    ...
    if(lengthList != index || index == 0){
      data = "Data: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Data"]}";
    }else {
      data = "Total Gasto";
    }

    if (lengthList != index || index == 0){
      milho = "Milho: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][0].toStringAsPrecision(strPrc[0])} ";
    } else{
      milho = "Milho: R\$ ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Valor"].toStringAsPrecision(strPrc[1])}";
    }

    if(lengthList != index || index == 0){
      qntSacos = "Qnt de Sacos: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][1]}";
    }else {
      qntSacos = "Qnt de Sacos: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Qnt"]}";
    }

    if(lengthList != index || index == 0){
      result = "Total: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][2].toStringAsPrecision(strPrc[2])} ";
    }else {
      result = "Total: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["Result"].toStringAsPrecision(strPrc[3])}";
    }
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if(lengthList != index || index == 0)(
                          tabelaGastos(milho,qntSacos,result)
                        )else(
                        tabelaResult(milho, qntSacos, result)
                        )
                  ],
                ),
            ),
  ...
  Future deleteButton(int indexCard) async {
    ...
    datasTxt = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName].keys.toList()[4+indexCard];
    final jsonFile = await JsonPath().localGAnimaisFileJson;

    for (int i = 0; i <= 2; i++){
      fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][listNameJson[i]] =
          fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][listNameJson[i]] -
              fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][i];
    }

    fileContent[jsonStart][indexYearDropDown][jsonName]["Result"] = fileContent[jsonStart][indexYearDropDown][jsonName]["Result"] -
        fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName][datasTxt]["Valores"][2];

    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName].removeWhere((key, value) => key == datasTxt);
    ...
    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0][jsonName]["LengthIncrement"] = fileLength;
