...
class BFMonth extends StatefulWidget {
  final int indexYearDropDown;
  const BFMonth(this.indexYearDropDown);

  @override
  _BFMonthState createState() => _BFMonthState();
}

class _BFMonthState extends State<BFMonth> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Balanço Financeiro Mensal",
          textScaleFactor: 1,
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          onChanged: (value) {
                            ...
                            finalResultSal = fileContentGAnimais["despesas"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2]["Sal"]["Result"];
                            finalResultRacao = fileContentGAnimais["despesas"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][3]["Ração"]["Result"];

                            finalResultFarmacia = fileContentFarmacia["farmacia"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth]["Valor"];
                            finalResultGasolina = fileContentGasolina["gasolina"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth]["Valor"];
                            finalResultMercado = fileContentMercado["mercado"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth]["Valor"];

                            finalResultOutrosGastos = fileContentOutrosGastos["outros"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["Valor"] + fileContentOutrosGastos["outros"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1]["Outros2"]["Result"];
                            ...
                            finalResultGado = fileContentGado["gado"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Gado"]["Result"];
                            finalResultLeite = fileContentGado["gado"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1]["Leite"]["Result"];
                            finalResultQueijo = fileContentGado["gado"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][2]["Queijo"]["Result"];
                            finalResultRequeijao = fileContentGado["gado"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][3]["Requeijao"]["Result"];

                            finalResultOutrasVendas = fileContentOutrasVendas["outros"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["Valor"] + fileContentOutrasVendas["outros"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth][1]["Outros2"]["Result"];

                            salario = fileContentSalario["salario"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth]["Salário"];
                            salarioExists = fileContentSalario["salario"][widget.indexYearDropDown][chooseYear][indexDropDown][chooseMonth]["SemSalário"];
                            print(salarioExists);
                            if(salarioExists == true){
                              salario = 0;
                            }
                            finalResultVendas = salario + finalResultOvos + finalResultFrangos +  finalResultGado + finalResultLeite + finalResultQueijo + finalResultRequeijao + finalResultOutrasVendas;
