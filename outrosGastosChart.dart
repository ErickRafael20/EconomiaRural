...
class OutrosGastos1Chart extends StatefulWidget {
  @override
  _OutrosGastos1ChartState createState() => _OutrosGastos1ChartState();
}

class _OutrosGastos1ChartState extends State<OutrosGastos1Chart> {
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            fileLength = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["LengthIncrement"];
                            length = fileLength + 1;
                            if(length == 1){
                              length = 0;
                            }
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            ...
                            print("$fileLength file length after");
                          });
  ...
  Future loadJson() async {
    final jsonFile = await JsonPath().localFileOutrosGastosJson;
    fileExist = await jsonFile.exists();
    if (fileExist) {
      fileContent = json.decode(jsonFile.readAsStringSync());
      print(fileContent[jsonStart][indexYearDropDown][chooseYear][11][chooseMonth]);
      loadDropDownYear();
    } else {
  ...
  Widget _despChartList(BuildContext context, int index, String nameOrder) {
    ...
    if(lengthList != index || index == 0) {
      datasTxt =
      fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]
          .keys.toList()[2 + index];
      resultCheck = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Valores"][1];
    }

    result2Check = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["Valor"];
    ...
    if(lengthList != index || index == 0){
      data = "Data: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Data"]}";
    }else {
      data = "Total Gasto";
    }

    if (lengthList != index || index == 0){
      nomeOutros1 = "Nome: ${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Valores"][0]} ";
    }


    if(lengthList != index || index == 0){
      result = "Valor: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Valores"][1].toStringAsPrecision(strPrc[0])} ";
    }else {
      result = "Total: R\$${fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["Valor"].toStringAsPrecision(strPrc[1])}";
    }
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(lengthList != index || index == 0)(
                tabelaGastos(nomeOutros1, result)
            )else(
                tabelaResult(result)
            )
          ],
  ...
  Widget tabelaGastos(String nomeOutros1, result){
    return Container(
  ...
  Future deleteButton(int indexCard ) async {
    ...
    datasTxt = fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"].keys.toList()[2+indexCard];
    final jsonFile = await JsonPath().localFileOutrosGastosJson;

    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][listNameJson] =
        fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][listNameJson] -
            fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Valores"][1];


    fileContent[jsonStart][indexYearDropDown]["Result"] = fileContent[jsonStart][indexYearDropDown]["Result"] -
        fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"][datasTxt]["Valores"][1];

    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"].removeWhere((key, value) => key == datasTxt);
    ...
    fileContent[jsonStart][indexYearDropDown][chooseYear][indexDropDown][chooseMonth][0]["Outros1"]["LengthIncrement"] = fileLength;
